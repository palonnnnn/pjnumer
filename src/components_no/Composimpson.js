...
export default class Composimpson extends Component {
    render() {
        return (
            <div>
                <div class="content-wrapper">
                    ...
                    <section className="content">
                        <div className="row">
                            <h2><b>Composite simpson's rule</b></h2>
                                    ...
                                    <form className="form-horizontal">
                                        <div className="box-body">
                                            ...
                                            <div className="form-group">
                                                ...
                                                <div className="col-sm-5">
                                                    <input type="text" className="form-control" id="xl" placeholder="" />
                                                </div>
                                            </div>

                                            {/* ค่า B */}
                                            <div className="form-group">
                                                <label className="col-sm-3 control-label">B :</label>
                                                <div className="col-sm-5">
                                             ...
                                             {/* ค่า N */}
                                             <div className="form-group">
                                                <label className="col-sm-3 control-label">N :</label>
                                                <div className="col-sm-5">
                                                    <input type="text" className="form-control" id="xr" placeholder="" />
                                                </div>
                                            </div>
